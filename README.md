...
* The system is used for solving **scenario tasks**, which require the user to meet power demand, prevent line overloads, and meeting cost and emissions' targets, allowing them to pursue a high score.
---
